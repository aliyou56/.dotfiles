...
xnoremap zM <Cmd>call VSCodeNotify('editor.foldAll')<CR>
xnoremap zR <Cmd>call VSCodeNotify('editor.unfoldAll')<CR>
xnoremap zc <Cmd>call VSCodeNotify('editor.fold')<CR>
xnoremap zC <Cmd>call VSCodeNotify('editor.foldRecursively')<CR>
xnoremap zo <Cmd>call VSCodeNotify('editor.unfold')<CR>
xnoremap zO <Cmd>call VSCodeNotify('editor.unfoldRecursively')<CR>
xnoremap za <Cmd>call VSCodeNotify('editor.toggleFold')<CR>
